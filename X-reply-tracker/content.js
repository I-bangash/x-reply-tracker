    ...
    function isReplyButton(element) {
        ...
        if (parentButton) {
            ...
            if (parentText.includes('reply')) {
                console.log('X Reply Tracker: Found reply button via parent data-testid');
                return true;
            }
        }
            ...
            mutations.forEach((mutation) => {
                mutation.addedNodes.forEach((node) => {
                    if (node.nodeType === Node.ELEMENT_NODE) {
                        ...
                        const replyButtons = node.querySelectorAll('[data-testid="tweetButtonInline"], [data-testid="tweetButton"]');
